...
Write-Host "`n▶ STEP 2: Installing JetBrains Mono Font" -ForegroundColor Magenta
Install-JetBrainsMono -FontName "JetBrainsMono" -FontDisplayName "JetBrainsMono NF"

Write-Host "`n▶ STEP 3: Installing Code Fonts" -ForegroundColor Magenta
Install-CodeFonts

Write-Host "`n▶ STEP 4: Installing VS Code Configuration" -ForegroundColor Magenta
Install-Config
